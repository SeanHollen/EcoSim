...
void addTestPlants() {
  ...
  Plant newPlant = new Plant(actions, newLocation1, 48, 48, 50);
  organisms.add(newPlant);
  
  Location newLocation2 = new Location(420, 400);
  actions.add(new GrowCanopy()); 
  Plant newPlant2 = new Plant(actions, newLocation2, 49, 49, 50);
